  ...
  return (
    <div className="flex h-screen overflow-hidden">
      <div className="flex-grow flex flex-col overflow-hidden">
        ...
        {randomChapter?.win && (<div className="w-[95%] mb-4 rounded-sm mx-auto flex flex-col items-center justify-center bg-success/80 text-background font-semibold h-28">
          <h3>Você ganhou!</h3>
        </div>)}
          {" "}
